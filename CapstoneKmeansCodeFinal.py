"""
This script can be run from within ArcGIS Pro as a python notebook in its current format
just replace the DB path with the path to the clean data in your directory structure.

Make sure to change which variable is being set in the Kmeans In Data variable as well as the fit 
in the Kmeans function and the number of classes desired. 
"""
