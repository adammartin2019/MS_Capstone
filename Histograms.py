...
#get all tif images
imPath = "C:/Users/Adam Martin/Desktop/School Files/UMD Files/GraduateSchool/MSGIS/GEOG797_Capstone/Data/Results/"
KMean_images = [imPath+"All_Data_6.tif", imPath+"CTX_NoD_DCS_6.tif", imPath+"NoD_6.tif"]
images = glob.glob("C:/Users/Adam Martin/Desktop/School Files/UMD Files/GraduateSchool/MSGIS/GEOG797_Capstone/Data/CleanedData/*_8bit.tif")


for i in range(len(images)):
    for j in range(len(KMean_images)):
        image_name = images[i].replace("C:/Users/Adam Martin/Desktop/School Files/UMD Files/GraduateSchool/MSGIS/GEOG797_Capstone/Data/CleanedData\\","")
        image_name = image_name.replace("_", " ").replace(".tif", "")
        kmean_image_name = KMean_images[j].replace("C:/Users/Adam Martin/Desktop/School Files/UMD Files/GraduateSchool/MSGIS/GEOG797_Capstone/Data/Results/","")
        ...
        savePath = "C:/Users/Adam Martin/Desktop/School Files/UMD Files/GraduateSchool/MSGIS/GEOG797_Capstone/Maps_Images/"
